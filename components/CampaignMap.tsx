                        ...
                        return (
                            <div key={stage.id} className={`relative z-10 pl-20 md:pl-28 transition-all ${isLocked ? 'opacity-50 grayscale' : ''}`}>
                                ...
                                <div className={`
                                    ...
                                    ${isLocked ? 'bg-gray-600' : isBoss ? 'bg-popRed scale-125' : 'bg-popBlue'}
                                `}>
                                ...
                                <div className={`
                                    ...
                                    ${isBoss ? 'border-popRed' : ''}
                                `}>
                                    <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                                        <div>
                                            <div className="flex flex-wrap items-center gap-2 mb-1">
                                                <span className={`font-black text-lg md:text-2xl uppercase italic ${isBoss ? 'text-popRed' : 'text-popBlue'}`}>
                                                    {stage.id}. {stage.name}
                                                </span>
                                                {stars > 0 && (
                                        ...
                                        <button 
                                            ...
                                            className={`
                                                ...
                                                ${isLocked ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-popBlack text-white hover:bg-popBlue hover:scale-105 cursor-pointer'}
                                            `}
                                        >
                                            {isLocked ? 'LOCKED' : (
